...
G0 X19.00 Y109.50 F3000;Move to A1 center
G92 X0 Y0;set A1 center as origin
G0 Z30.00 F300;Move to safe Z height before moving to reservoir
G0 X26.00 Y90.50 F3000;align XY above reservoir
...
M118;Please replace solvent reservoir with waste container and add stock solution to second container position, then click resume on printer to continue with serial dilution.
