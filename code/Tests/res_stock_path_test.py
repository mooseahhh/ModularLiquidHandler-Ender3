...
def res_path_action(file): # test fxn to move to reservoir, then stock solution, then back to A1 center, performing lower raise action at each location to test z heights for each location
