...
def column_action(file,curr_x_pos=0,columns=12): # perform pipette action for each row of the plate, moving down the rows and then back up to the first row at the end
...
def row_action(file,curr_y_pos=0,row=8): # perform pipette action for each column of the plate, moving down the columns and then back up to the first column at the end
    curr_y_pos = -WELL_SPACING
